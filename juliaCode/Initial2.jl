...
function cnot!(a,b,showOutput=false)
   global state;
  cnot(state,a,b,showOutput)
end

function cnot(state,a,b,showOutput=false)
...
function hadamard!(a,showOutput=false)
  global state;
  hadamard(state,a,showOutput)
end

function hadamard(state,a,showOutput=false)
...
function phase!(a,showOutput=false)
  global state
  phase(state,a,showOutput)
end

function phase(state,a,showOutput=false)
